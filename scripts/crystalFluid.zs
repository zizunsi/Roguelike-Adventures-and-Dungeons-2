...
game.setLocalization("fluid.fluidMagicCrystal", "流体魔力");
game.setLocalization("fluid.fluidFireCrystal", "流体火");
game.setLocalization("fluid.fluidIceCrystal", "流体冰");
game.setLocalization("fluid.fluidStormCrystal", "流体闪电");
game.setLocalization("fluid.fluidNecroCrystal", "液体亡灵");
game.setLocalization("fluid.fluidEarthCrystal", "流体自然");
game.setLocalization("fluid.fluidMystCrystal", "流体魔法");
game.setLocalization("fluid.fluidHealCrystal", "流体治愈");